package polymorphismExercise.E02VehiclesExtension;
...
public class Vehicle implements Drivable {
    ...
    public Vehicle(double fuelQuantity, double fuelConsumption, double tankCapacity, double CONSUMPTION_INCREASE_VALUE) {
