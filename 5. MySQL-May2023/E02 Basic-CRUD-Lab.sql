...
SELECT id, CONCAT(first_name, ' ', last_name), job_title, salary FROM employees WHERE salary > 1000.00 ORDER BY id;
...
SELECT * FROM employees WHERE department_id = 4 AND salary >= 1000.00 ORDER BY id;
