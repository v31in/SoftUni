...
public class P05ListManipulationAdvanced {
    ...
    public static void distribution(Scanner scanner, List<Integer> numsList) {
        String input = "";
    ...
    public static void containsNumber(List<Integer> numsList, int number) {
    ...
    public static void printSumOfNums(List<Integer> numsList) {
    ...
    public static void filterNums(List<Integer> numsList, String condition, int number) {
